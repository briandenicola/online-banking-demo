...
public class AuthServiceTests
{
    ...
    public AuthServiceTests()
    {
        ...
        {
            // No signing key and no audience: after #334 both are retired configuration.
            // The key is generated by the issuer, the audiences come from the canonical
            // registry. A test that still set them would be asserting a model nothing runs.
