...
## Archival Marker — 2026-05-13

**decisions.md size:** 105KB (>20KB threshold)

**Archival sweep needed:** Move decisions older than 2026-04-13 (30 days) to this archive to reduce decisions.md size below 20KB. Recent decisions (2026-05-01 onward) should remain in decisions.md for active team reference.

**Candidates for archival** (in decisions.md):
- Decision entries dated 2026-04-13 or earlier (review manually to avoid losing active context)
- Currently not automatically moved; recommend manual sweep by Scribe or team lead during next planning cycle.
